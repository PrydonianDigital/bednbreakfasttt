...
extract( $field );
?>
<p>Please select the amount of items you require above, then choose the date you want the items ready for delivery/collection below.</p>
<fieldset class="wc-bookings-date-picker <?php echo implode( ' ', $class ); ?>">
	<legend>
		<span class="label">Delivery Date</span>: <small class="wc-bookings-date-picker-choose-date">Choose <i class="icon-calendar"></i></small>
	</legend>
