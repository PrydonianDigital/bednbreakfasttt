...
<p><?php _e( 'Your order has been confirmed. The details of your order are shown below.', 'woocommerce-bookings' ); ?></p>

<table cellspacing="0" cellpadding="6" style="width: 100%; border: 1px solid #eee;" border="1" bordercolor="#eee">
	<tbody>
		<tr>
			<th scope="row" style="text-align:left; border: 1px solid #eee;"><?php _e( 'Ordered Product', 'woocommerce-bookings' ); ?></th>
...
<?php if ( $order = $booking->get_order() ) : ?>
	...
	<?php if ( $order->status == 'pending' ) : ?>
		<p><?php printf( __( 'To pay for this order please use the following link: %s', 'woocommerce-bookings' ), '<a href="' . esc_url( $order->get_checkout_payment_url() ) . '">' . __( 'Pay for booking', 'woocommerce-bookings' ) . '</a>' ); ?></p>
	<?php endif; ?>
